...
export default defineConfig({
  ...
  define: {
    ...
    "process.env.VITE_SERVER_WEBSOCKET_URL": JSON.stringify(
      process.env.VITE_SERVER_WEBSOCKET_URL
    ),
    ...
    "process.env.VITE_CRYPTO_SECRET_KEY": JSON.stringify(
      process.env.VITE_CRYPTO_SECRET_KEY
    ),
  },
});
